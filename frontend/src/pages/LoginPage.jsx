...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      ...
      // Success: check if app lock passcode is set
      if (settings.passcode) {
        navigate('/lock', { state: { redirectTo: '/home' } });
      } else {
        navigate('/home');
      }
    }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Sign in to access your meeting transcripts</p>
        ...
        <div style={styles.bottomLinkRow}>
          <span style={styles.plainText}>Don't have an account? </span>
